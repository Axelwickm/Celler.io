...
module.exports = {
	Attraction:Attraction,Behaviour:Behaviour,Collision:Collision,ConstantForce:ConstantForce,EdgeBounce:EdgeBounce,EdgeWrap:EdgeWrap,Euler:Euler,ImprovedEuler:ImprovedEuler,Integrator:Integrator,Particle:Particle,Physics:Physics,Random:Random,Spring:Spring,Vector:Vector,Verlet:Verlet,Wander:Wander
}